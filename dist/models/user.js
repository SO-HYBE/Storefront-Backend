            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1["default"].hashSync(b.userpassword + process.env.BCRYPT_PASSWORD, parseInt(process.env.SALT_ROUNDS));
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create new user : ".concat(b.username, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.authenticate = function (username, userpassword) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (result.rows.length) {
                            user = result.rows[0];
                            console.log(user);
                            if (bcrypt_1["default"].compareSync(userpassword + process.env.BCRYPT_PASSWORD, user.userpassword)) {
                                return [2 /*return*/, user];
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Users can not be deleted . Error: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
