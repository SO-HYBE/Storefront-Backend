    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                res.status(400);
                res.json(err_1 + product);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
var selectCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.selectProductByCategory(req.params.category)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
...
var productRoutes = function (app) {
    ...
    app.post('/products', authMiddleware_1.verifyAuthToken, create);
